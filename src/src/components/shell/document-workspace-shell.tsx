    ...
    <div className="kb-shell flex h-full min-h-full text-white">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <div className="border-b border-white/10 bg-black/20 px-5 py-4 backdrop-blur-xl">
          ...
          <div>
            <div className="text-[11px] uppercase tracking-[0.24em] text-slate-400">笔记工作区</div>
        ...
        <div className="min-h-0 flex-1 overflow-hidden">
          {!isKbOpen ? (
            <div className="flex h-full items-center justify-center px-6 py-10">
              <div className="w-full max-w-3xl rounded-[2rem] border border-amber-200/16 bg-[linear-gradient(180deg,_rgba(24,22,18,0.96)_0%,_rgba(10,12,18,0.98)_100%)] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.28)]">
                <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
                  ...
                  <div className="rounded-[1.5rem] border border-white/10 bg-black/20 p-5">
                    <div className="text-[11px] uppercase tracking-[0.22em] text-slate-400">核心流程</div>
                    <div className="mt-4 space-y-3 text-sm text-slate-300">
                      <div className="rounded-[1rem] border border-white/10 bg-white/4 px-4 py-3">
                        阅读器负责保留原文和引用上下文。
                      </div>
                      <div className="rounded-[1rem] border border-white/10 bg-white/4 px-4 py-3">
                        笔记和草稿始终跟着当前资料走。
            ...
            <div className="flex h-full items-center justify-center text-center">
              <div className="space-y-3">
                ...
                <div className="text-base font-medium text-slate-300">先选择一份资料，再开始笔记工作流</div>
                <div className="text-sm text-slate-500">当前资料会驱动阅读、笔记和草稿，不再让高级输出抢走主流程。</div>
              </div>
            </div>
          ) : isLoading ? (
